...
float H_LAMBDA_S1 = .18f;
float H_LAMBDA_S2 = .2225f;
float F_LAMBDA_S1 = .98f;
...
int main() {
    ...
    Retailer retailer2(5);
    retailer2.copy(retailer);

    bool multiAlgo = false;
